        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-lg-7 text-center col-sm-12 element-animate">
              ...
              <h1 class="mb-4"><span>Nous sommes ACPM</span></h1>
              <p class="mb-5 w-75">Dépannage, vente et installation de matériel électrotechnique pour particuliers et entreprises.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="slider-item" style="background-image: url('images/industrial_hero_2.jpg');">
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-lg-7 text-center col-sm-12 element-animate">
              <div class="btn-play-wrap mx-auto"><p class="mb-4"><a href="https://vimeo.com/59256790" data-fancybox data-ratio="2" class="btn-play"><span class="ion ion-ios-play"></span></a></p></div>
              <h1><span>Spécialiste de l'électrotechnique dans les Ardennes</span></h1>
              <p class="mb-5 w-75">La société ACPM vient de déménager dans un bâtiment de 600 m² à Lumes - 31 grande rue pour mieux répondre à vos besoins. Situé au pied de l’autoroute, cela permet d’améliorer notre réactivité pour les dépannages.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center mb-5">
          ...
          <div class="col-md-5 pr-md-5 mb-5">
            <div class="block-41">
              <h2 class="block-41-heading mb-5">Construisons ensemble</h2>
              <div class="block-41-text">
                <p>Depuis maintenant quelques années ACPM distribue de nombreuses marques telles que <em>Bayrol</em> ou encore <em>Astrapool</em>.</p>
                <p><a href="https://piscine08.wordpress.com/nos-marques/" class="readmore">Lire la suite<span class="ion-android-arrow-dropright-circle"></span></a></p>
              </div>
            </div>
          </div>
